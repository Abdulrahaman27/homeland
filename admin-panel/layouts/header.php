<?php
    session_start();
    define("ADMIN_URL", "http://localhost/homeland/admin-panel");
...
<div id="wrapper">
    <nav class="navbar header-top fixed-top navbar-expand-lg  navbar-dark bg-dark">
      ...
      <ul class="navbar-nav side-nav" >
          <li class="nav-item">
            <a class="nav-link text-white" style="margin-left: 20px;" href="<?php echo ADMIN_URL; ?>">Home
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMIN_URL; ?>/properties-admins/show-properties.php" style="margin-left: 20px;">Properties</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo ADMIN_URL; ?>/requests-admins/show-requests.php" style="margin-left: 20px;">Requests</a>
          </li>
        </ul>
        <?php endif; ?>
